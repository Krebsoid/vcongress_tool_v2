...
vielen Dank für die Übermittlung Ihrer Daten zur Anmeldung bei der folgenden Veranstaltung:
...
Ihr Login Name ist: ${person.user().name()}
Sie können sich erneut unter folgendem Link einloggen: ${event.registrationLink()}
