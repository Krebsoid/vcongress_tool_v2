...
please find enclosed your invoice as a pdf for the following event:
...
We ask to settle the invoice within 14 days by bank transfer or “PayPal” as selected payment type (via the vCongress System(${event.registrationLink()})).
