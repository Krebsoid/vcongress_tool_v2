...
anbei erhalten Sie Ihre Rechnung als PDF zur folgenden Veranstaltung:
...
Bitte bezahlen Sie die Rechnung innerhalb von 14 Tagen per Überweisung oder bei Auswahl "PayPal" über PayPal (über das vCongress System (${event.registrationLink()})).
